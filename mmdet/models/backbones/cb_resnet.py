...
class Bottleneck(BaseModule):
    ...
    def __init__(self,
        ...
        self.cbam = CBAM(planes * self.expansion, r,use_gumbel=use_gumbel,use_gumbel_cb=use_gumbel)
...
class CBAM_ResNet(BaseModule):
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 use_gumbel=False):
        super(CBAM_ResNet, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(CBAM_ResNet, self).train(mode)
        self._freeze_stages()
