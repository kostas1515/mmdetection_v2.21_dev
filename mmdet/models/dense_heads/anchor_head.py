...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
        ...
        self.use_custom_activation = loss_cls.get('use_custom_activation', False)
        self.use_extra_cls_out_channels = loss_cls.get('use_extra_cls_out_channels', 0)
        if self.use_sigmoid_cls:
            self.cls_out_channels = num_classes + self.use_extra_cls_out_channels
        else:
