model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='./pretrained/se_x50_inet_e100_aaug_gumbel_se.pth'),
        use_gumbel=True),
    neck=dict(
        type='FPN',
...
workflow = [('train', 1)]
cfg_root = '../lvis/'
# work_dir = 'experiments/droploss_normed_mask_x50_rfs_4x4_2x_gumbel_gumbel_se/'
work_dir = 'experiments/droploss_normed_mask_se_x50_rfs_4x4_2x_gumbel_gumbel_se/'
gpu_ids = range(0, 4)
auto_resume = False
