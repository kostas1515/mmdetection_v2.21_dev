model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='./pretrained/cb_r152_inet_e100_aaug.pth'),
        use_gumbel=False),
    neck=dict(
        type='FPN',
...
work_dir = 'experiments/droploss_normed_mask_cb_r152_rfs_4x4_2x_gumbel_adamw'
gpu_ids = range(0, 4)
auto_resume = False
