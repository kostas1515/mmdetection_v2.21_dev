model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='./pretrained/cb_r152_inet_e100_aaug_gumbel_se.pth'),
        use_gumbel=True),
    neck=dict(
        type='FPN',
...
work_dir = 'experiments/droploss_normed_mask_cb_r152_rfs_4x4_2x_gumbel_gumbel_se_adamw'
gpu_ids = range(0, 4)
auto_resume = False
