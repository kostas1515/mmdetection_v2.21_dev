_base_ = [
    '../atss_r50_fpn_2x_coco.py'
]


model = dict(
    bbox_head=dict(
        loss_cls=dict(type="GumbelFocalLoss",num_classes=80,gamma=0,alpha=0.1),
...
work_dir='./experiments/coco/atss_r50_fpn_2x_coco_gumbel_g0_a01/'
