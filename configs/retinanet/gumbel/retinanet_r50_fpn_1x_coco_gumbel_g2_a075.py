...
model = dict(bbox_head=dict(loss_cls=dict(type="GumbelFocalLoss",num_classes=80,gamma=2.0,alpha=0.75),
                                         init_cfg=dict(type='Normal',layer='Conv2d',std=0.01,override=dict(type='Normal',name='retina_cls',std=0.01,bias_prob=0.08))
                                         ))

work_dir='./experiments/coco/retinanet_r50_fpn_1x_coco_gumbel_g2_a075/'
